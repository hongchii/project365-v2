...
public class AnswerController {
 ...
 //한달치 답변갯수를 출력
 	@GetMapping("/calendars/{month}/{day}")
 	//public int countRead(@PathVariable("month") int month,@PathVariable("day") int day ) {
 	public List<Integer> countRead(@PathVariable("month") int month,@PathVariable("day") int day ) {
 		int result =0;
